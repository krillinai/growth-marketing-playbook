...
| Title | URL | Relevance |
| --- | --- | --- |
| Acquisition Handbook | [../../acquisition/README.md](../../acquisition/README.md) | Separates traffic volume from qualified and retained demand and requires downstream value evidence. |
| GEO Handbook | [../../geo/README.md](../../geo/README.md) | Extends discoverability to AI answers and citations; relevant only when visibility can be connected to qualified outcomes. |
...
| Skill references | [Growth Skills SEO Audit](https://github.com/krillinai/growth-skills/tree/main/skills/seo-audit), used only for the bounded 50-page technical/content execution audit after the business diagnosis |
