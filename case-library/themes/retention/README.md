...
For retention models, cohort metrics, and diagnosis, see [Retention](../../../handbook/retention/README.md).

## Company Evidence

| Company | Recurring value | Reinforcement | Validation and boundary |
| --- | --- | --- | --- |
...
1. Is recurring value habitual, networked, workflow-embedded, or episodic?
2. What would users return for without notifications or rewards?
